...
function Userdetails() {
    ...
    let saveData = (e, id) => {
        ...
        //     dataValidation.mobile_no="Mobile number is required"
        // }
        // if(!input_data.user_type){
        //     dataValidation.user_type="User  is required"
        // }
        ...
        toast.success("Welcome to our React Js")
    }
                ...
                <form onSubmit={saveData}>
                    ...
                    <Modal.Body>
                        ...
                        <div className="form-group py-2">
                            ...
                            <span className='text-danger'>{error.mobile_no}</span>
                        </div>
                        ...
                        <div className="form-group py-2">
                            ...
                            <span className='text-danger'>{error.user_type}</span>
                        </div>

                        <div className="form-group py-2">
                            <label htmlFor="exampleInputEmail1">Password</label>
                            <input type="password" className="form-control" id="password" name="password" placeholder="Enter Password" value={input_data.password} onChange={setData} />
